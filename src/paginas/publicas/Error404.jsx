    ...
    return (
        <>
            ...
            <section className='w-full flex flex-col justify-between items-center content-center' style={{height: "80vh"}}>
                {/* Contenido de aviso */}
                <div className='flex flex-col justify-center items-center content-center justify-items-center mt-12 w-5/6 lg:w-3/5 bg-white p-10 rounded-xl shadow-lg'>
                    {/* Titulo */}
                    <div className='my-2 flex items-center'>
                        <img src="/img/no-hay-resultados.png" alt="" width="50" className="mx-2"/>
                        <h2 className='text-xl lg:text-5xl font-bold mx-2'>Pagina No Encontrada</h2>
                    </div>

                    {/* Descripcion */}
                    <div className='lg:my-10 flex'>
                        <div>
                            <p className='my-1 lg:my-5'>
                                No se ha encontrado la pagina busqueda. Esto se puede deber a: 
                            </p>

                            <ul className='my-1 lg:my-5 ml-5 list-disc'>
                        ...
                        <img src="/img/direcciones.png" alt="direccion" width="200" className="hidden lg:inline"/>
                    </div>
